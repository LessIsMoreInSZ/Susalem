...
{
    [Authorize(SusalemPermissions.IdentityClaimType.Default)]
    public class IdentityClaimTypeAppService : IdentityAppServiceBase, IIdentityClaimTypeAppService
    {
        ...
        [Authorize(SusalemPermissions.IdentityClaimType.Create)]
        ...
        [Authorize(SusalemPermissions.IdentityClaimType.Delete)]
        ...
        [Authorize(SusalemPermissions.IdentityClaimType.Update)]
        ...
        protected virtual void CheckChangingClaimType(IdentityClaimType claimType)
        {
            ...
            {
                throw new BusinessException(Identity.IdentityErrorCodes.StaticClaimTypeChange);
            }
        }
        ...
        protected virtual void CheckDeletionClaimType(IdentityClaimType claimType)
        {
            if (claimType.IsStatic)
            {
                throw new BusinessException(Identity.IdentityErrorCodes.StaticClaimTypeDeletion);
            }
        }
    }
}
