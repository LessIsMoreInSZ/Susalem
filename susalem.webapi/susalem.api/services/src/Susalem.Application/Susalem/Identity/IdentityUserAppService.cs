...
namespace Susalem.Identity
{
    ...
    public class IdentityUserAppService : Volo.Abp.Identity.IdentityAppServiceBase, IIdentityUserAppService
    {
        ...
        [Authorize(SusalemPermissions.Users.ManageOrganizationUnits)]
        ...
        public async virtual Task<ListResultDto<IdentityClaimDto>> GetClaimsAsync(Guid id)
        {
            ...
            return new ListResultDto<IdentityClaimDto>(ObjectMapper.Map<ICollection<Volo.Abp.Identity.IdentityUserClaim>, List<IdentityClaimDto>>(user.Claims));
        }

        [Authorize(SusalemPermissions.Users.ManageClaims)]
        ...
        [Authorize(SusalemPermissions.Users.ResetPassword)]
        ...
        protected async virtual Task<Volo.Abp.Identity.IdentityUser> GetUserAsync(Guid id)
        {
