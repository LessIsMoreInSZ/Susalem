using AutoMapper;
using Susalem.Abp.IdentityServer.ApiResources;
using Susalem.Abp.IdentityServer.ApiScopes;
using Susalem.Abp.IdentityServer.Clients;
using Susalem.Abp.IdentityServer.Grants;
using Susalem.Abp.IdentityServer.IdentityResources;
