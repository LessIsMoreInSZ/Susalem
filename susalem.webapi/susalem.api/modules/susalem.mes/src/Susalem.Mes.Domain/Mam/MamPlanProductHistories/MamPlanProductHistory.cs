...
namespace Susalem.Mam.MamPlanProductHistories
{
    /// <summary>
    /// 【领域实体】产品清单历史
    /// </summary>
    public class MamPlanProductHistory : Entity<Guid>, IHasCreationTime, IHasExtraProperties
    {
        /// <summary>
        /// SN编码
        /// </summary>
        ...
        /// 【领域实体】产品清单历史
        /// </summary>
        protected MamPlanProductHistory()
        {
        ...
        /// <param name="downlineTime">下线时间</param>
        ...
        protected MamPlanProductHistory(
          ...
          [NotNull] DateTime onlineTime,
          [NotNull] DateTime downlineTime,
